...
// METHOD - 2
// Ref: https://www.geeksforgeeks.org/inplace-rotate-square-matrix-by-90-degrees/

// Here time complexity is same as METHOD - 1 but the same has been achieved in a single paas.
...
void rotate_anti_clock(vvi &v) {
    ...
    // consider all concentric squares of the matrix one by one
    for(int i = 0; i < (n / 2); i++) {
        // consider elements in group of 4 in the current square

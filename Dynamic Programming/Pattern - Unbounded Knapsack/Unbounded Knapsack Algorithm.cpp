...
ll ub_knapsack(vi &wt, vi &val, ll w, int n) {
	// base condition(s)
...
// NOTE: The for loop in the ub_knapsack() function can also be written in this way also ===>
/*
	for(int i = 0; i < n; i++) {
		for(int cap = 1; cap <= w; cap++) {
			if(wt[i] > cap) continue;
	...
	Reason why both ways are correct:===>
	https://www.youtube.com/watch?v=jgps7MXtKRQ&list=PL-Jc9J83PIiG8fE6rj9F5a6uyQ5WPdqKy&index=17
*/
...
// Time Limit: 2000 ms
// Parsed on: 09-08-2021 20:51:56 IST (UTC+05:30)
...
// dp[i] = length of the longest path starting from node i
vi dp;
...
void solve()
{
    ...
    // the length of a directed path is the number of edges in it
  	int res = 0;

...
// LEGACY CONTENT: https://gist.github.com/Edith-3000/2347e4a84bb605662485cf1f3cc66460
...
// NOTE: prv should be passed by reference
void flatten_helper(TreeNode *root, TreeNode* &prv) {
	// base case
	if(root == NULL) return;
	
	flatten_helper(root->right, prv);
	flatten_helper(root->left, prv);
...
// Makes use of concept used in Morris Traversal.

...
// JUST AN OBSERVATION: Every symmetrical binary tree's inorder traversal will be palindrome, but not vice versa. 
...
bool is_symmetric(TreeNode *root) {
	...
	while(!q.empty()) {
		...
		else if(cur1->left or cur2->right) return 0;
		...
		else if(cur1->right or cur2->left) return 0;
	}

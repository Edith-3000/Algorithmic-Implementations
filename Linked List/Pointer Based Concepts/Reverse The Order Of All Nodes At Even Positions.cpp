...
// Ref: https://www.educative.io/courses/coderust-hacking-the-coding-interview/lOxKj
/*******************************************************************************************************/
...
ListNode* reverse_even_nodes(ListNode *head) {
	if(!head or !head->next) return head;
	
	ListNode *tmp = head, *even_head = NULL;
	...
	head = merge_2_sorted_lists(head, even_head);
	return head;
}
...
void solve()
{
    ...
    l.display();
    l.head = reverse_even_nodes(l.head); 
    l.display();

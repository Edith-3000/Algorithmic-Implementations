...
void solve()
{
  	// NOTE: according to the problem statement, n >= 2 
  	int n; cin >> n;
  	LinkedList l;
  	...
  	// https://www.journaldev.com/43739/random-number-generator-c-plus-plus#:~:text=Generate%20random%20numbers%20within%20a%20range&text=For%20instance%2C%20in%20order%20to,%2B%20(%20rand%20()%20%25%209)%3B
  	int random = rand() % (n - 1);

...
// Change functions accordingly when needed, here functions are coded for range minimum queries
// NOTE: this is w/o lazy propagation 
struct seg_tree {
	// data members ==>
...
// JAVA CODE (for range sum): https://gist.github.com/Edith-3000/ba8f2858a69248745350ea26270bd0f1
...
/* # Time complexities of functions of struct seg_tree :--->
     ...
     * range_update(): O(n), since in the worst case we may be updating all (4 x n) vertices of the Segment 
                       Tree, such as consider the case of range update from [0, n - 1]
*/